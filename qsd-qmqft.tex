...
\newcommand{\qsdpapertitle}{Quantum Theory as a Pacing-Limited Regime: Collapse, Coherence, and Causality in a Conserved Substrate}
...
\newcommand{\qsdgptname}{OpenAI’s ChatGPT}
\newcommand{\qsdgptver}{GPT-4o}
\newcommand{\qsdgptyear}{2025}
\newcommand{\qsdkeywords}{Quantum mechanics, Quantum field theory, Collapse, Measurement, Causality Interval, Collapse Boundary, Quantum Emission Opportunity, Time symmetry, Entanglement, Coherence, Substrate dynamics, Structural re-lock, Serialized emission, Frame-dependent time, Quantum Substrate Dynamics}
